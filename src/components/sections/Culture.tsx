...
const Culture = () => {
  ...
  return (
    ...
    >
      ...
      <Header useMotion={true} p="传统文化" h2="芗剧文化科普" />
      ...
      <div className="mt-10 space-y-12">
        ...
        >
          ...
          >
            ...
            芗江是福建九龙江流经漳州时的简称。芗剧是
            <span className="text-[#e3d7b1] font-semibold">
              全国 360 多个地方戏 剧中唯一横跨海峡的剧种
            </span>
            ，也是两岸群众文艺交流的纽带。其足迹
            遍及于龙溪、晋江、厦门、台湾省及东南亚华侨居住地区。
          </motion.p>
          <img
            src="http://t0yy8qojh.hn-bkt.clouddn.com//word图片/1.webp"
            alt="culture"
            className="w-full h-[700px] object-cover rounded-2xl mt-8"
          />
        </motion.div>
        ...
        >
          ...
          <div className="text-secondary text-[17px] leading-[30px] space-y-6">
            ...
            <div>
              ...
              <p>
                &emsp;&emsp;芗剧，原名歌仔戏，亦名子弟戏，起源于漳州。
                <span className="text-[#e3d7b1] font-semibold">明末清初，郑 成功率部收复台湾</span>
                ，把流传于漳州的"歌仔"（锦歌）、"车鼓
              ...
              <p>
                ...
                及表演艺术,在农村谷场、庙埕牵草绳圈地演出,民间俗称
                <span className="text-[#e3d7b1] font-semibold">"落地扫"</span>。
                逢年过节，也搭戏棚表演。因为是从"歌仔阵"发展起来的，故称 歌仔戏。
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                博采其他剧种的优秀剧目与表演艺术，民国初年盛行一时。
                <span className="text-[#e3d7b1] font-semibold">
                  民国 17 年（1928 年）4 月，台湾歌仔戏三乐轩班来漳州白礁慈济宫进香、 演出
                </span>
                ，大受群众欢迎。
              </p>
              <p>
                ...
                <span className="text-[#e3d7b1] font-semibold">
                  邵江海、林文祥等艺人从锦歌吸收养分,创作了杂碎调
                </span>
                。他们以杂碎调为主曲, 六角弦为主弦，并吸收高甲戏、梨园戏、竹马戏、汉剧部分曲调，
                融汇南曲、南词、山歌小调，重新创作一套新的唱腔改良调，搬上 舞台演出，时称
                <span className="text-[#e3d7b1] font-semibold">改良戏</span>。
              </p>
            ...
            <div>
              ...
              <p>
                &emsp;&emsp;新中国成立后，由于改良调（子弟戏）主要流行于龙溪芗江一 带，就
                <span className="text-[#e3d7b1] font-semibold">正式改称芗剧</span>。
                <span className="text-[#e3d7b1] font-semibold">
                  1951 年 8 月，歌仔戏霓光班与子弟戏新春 班合并成立漳州市实验芗剧团
                </span>
                。从此，芗剧逐渐发展成为福建省五 大剧种之一。
              </p>
              <p>
                &emsp;&emsp;
                <span className="text-[#e3d7b1] font-semibold">
                  1960 年，龙溪专区芗剧团（原漳州实验芗剧团）参加全国巡回演出
                </span>
                ，进一步 扩大芗剧的影响和知名度。1979 年，新编歌仔戏现代剧《双剑春》晋京参加建国 30
                周年献礼演出, 芗剧首次进入首都舞台。
              </p>
              <div className="bg-black/20 rounded-lg p-4 mt-4">
              ...
              <img
                src="http://t0yy8qojh.hn-bkt.clouddn.com//word图片/2.jpg"
                alt="culture"
                className="w-full h-[600px] object-cover rounded-2xl mt-8"
              />
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="text-secondary text-[17px] leading-[30px] space-y-6">
            <div>
              <p>
                &emsp;&emsp;芗剧的传统剧目大约有
                <span className="text-[#e3d7b1] font-semibold">五百多个</span>
                。最初多用歌仔戏的唱本，进
                入城市后，增加了历史题材的剧目，多是从其他剧种或小说改编来 的连台本戏。
              </p>
            ...
            <div>
              ...
              <img
                src="http://t0yy8qojh.hn-bkt.clouddn.com//word图片/3.webp"
                alt="culture"
                className="w-full h-[600px] object-cover rounded-2xl mt-8"
              />
              <p>
                ...
                织力量对传统剧目进行发掘、记录、整理。
                <span className="text-[#e3d7b1] font-semibold">
                  芗剧老艺人口述的传统剧目有 984 个，至 1963 年记录 410 个
                </span>
                ，其中 42 个剧本收入《传统剧目选》，4 个剧目收入《中国戏曲选》（福 建省卷）。
              </p>
            </div>
        ...
        >
          ...
          <div className="text-secondary text-[17px] leading-[30px] space-y-6">
            ...
            <div>
              ...
              <p>
                &emsp;&emsp;芗剧唱腔为
                <span className="text-[#e3d7b1] font-semibold">民歌联缀体结构</span>
                ，分为五种主要类型：
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg p-4 border border-blue-500/20">
                  ...
                  <p className="text-[15px]">
                    由锦歌发展而成，羽调式，分高、低两腔。高腔适于表现喜悦、激动之情；低腔适于沉思、悲叹。
                  </p>
                </div>
                <div className="bg-gradient-to-r from-green-900/30 to-blue-900/30 rounded-lg p-4 border border-green-500/20">
                  ...
                  <p className="text-[15px]">
                    从锦歌【杂碎】改良发展而成，旋律丰富，板式多样，适于叙述抒情。
                  </p>
                </div>
                <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-lg p-4 border border-purple-500/20">
                  ...
                  <p className="text-[15px]">
                    又称【台湾杂念调】，旋律、节奏、速度都比较自由灵活，是唱念结合的多段体宣叙调。
                  </p>
                </div>
                <div className="bg-gradient-to-r from-red-900/30 to-orange-900/30 rounded-lg p-4 border border-red-500/20">
                  ...
                  <p className="text-[15px]">
                    从丧礼哭腔和民俗歌谣中提炼，有【大哭调】、【艋舺哭】、【宜兰哭】等近20首曲牌。
                  </p>
                </div>
              </div>
              <div className="bg-gradient-to-r from-yellow-900/30 to-green-900/30 rounded-lg p-4 border border-yellow-500/20 mt-4">
                ...
                <p className="text-[15px]">
                  俗称"调仔"，有【锦歌五空仔】、【倍思仔】、【思想起】、【心酸酸】、【行船调】等100多支曲牌。
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p>&emsp;&emsp;芗剧的主要乐器具有浓郁的闽南特色：</p>
              <div className="bg-black/20 rounded-lg p-4 mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-[15px]">
                  <div>
                    <span className="text-[#e3d7b1] font-semibold">• 壳仔弦：</span>
                    用椰壳制成的特色弦乐器
                  </div>
                  <div>
                    <span className="text-[#e3d7b1] font-semibold">• 大广弦：</span>
                    用龙舌茎作共鸣箱，梧桐木为箱板
                  </div>
                  <div>
                    <span className="text-[#e3d7b1] font-semibold">• 台湾笛：</span>
                    又名梆子箫，音色清脆
                  </div>
                  <div>
                    <span className="text-[#e3d7b1] font-semibold">• 月琴：</span>
                    圆形共鸣箱的弹拨乐器
                  </div>
                  <div>
                    <span className="text-[#e3d7b1] font-semibold">• 六角弦：</span>
                    又名二胡，共鸣箱为六角形
                  </div>
                  <div>
                    <span className="text-[#e3d7b1] font-semibold">• 鸭母笛：</span>
                    又名竖管，簧嘴似鸭嘴巴
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gradient-to-b from-blue-900/30 to-transparent rounded-lg p-4 border border-blue-500/20">
                  ...
                  <p className="text-[14px]">
                    即丝弦乐曲，曲牌有200多首，常用的有【一枝花】、【珠串】、【菊花串】等80多首。
                  </p>
                </div>
                <div className="bg-gradient-to-b from-green-900/30 to-transparent rounded-lg p-4 border border-green-500/20">
                  ...
                  <p className="text-[14px]">
                    用大唢呐吹奏的曲牌，有军乐【朝元歌】、喜乐【科场】、哀乐【火石榴】等近80首。
                  </p>
                </div>
                <div className="bg-gradient-to-b from-purple-900/30 to-transparent rounded-lg p-4 border border-purple-500/20">
                  ...
                  <p className="text-[14px]">
                    即锣鼓经，现有120多种，分场面介头、唱腔介头、科白介头、哗牌介头四类。
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-secondary text-[17px] leading-[30px] space-y-6">
            ...
            <div>
              ...
              <p>
                ...
                分行，角色增加。芗剧音乐的特点是
                <span className="text-[#e3d7b1] font-semibold">
                  唱多旁白少，曲调自由，旋律 优美，节奏强烈
                </span>
                ，富有较强的表现力和乡土情调。
              </p>
              <img
                src="http://t0yy8qojh.hn-bkt.clouddn.com//word图片/4.webp"
                alt="culture"
                className="w-full h-[600px] object-cover rounded-2xl mt-8"
              />
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-red-900/30 to-orange-900/30 rounded-lg p-4 border border-red-500/20">
                  ...
                  <p className="text-[15px] mb-2">
                    丑角表演滑稽风趣，诙谐幽默。一出场便背着舞台走矮步，称为
                    <span className="text-[#e3d7b1] font-semibold">"矮桩形"</span>，
                    分为高桩、中桩和短桩三种。
                  </p>
                ...
                <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg p-4 border border-blue-500/20">
                  ...
                  <p className="text-[15px]">
                    小生头戴罗帽，身穿短衣，腰系白堂裙，右手舞
                    <span className="text-[#e3d7b1] font-semibold">"扇子花"</span>， 左手甩
                    <span className="text-[#e3d7b1] font-semibold">"长袖筒"</span>
                    ，载歌载舞，轻松自如。 手势动作配合高步、矮步，体现生活情形。
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-pink-900/30 to-purple-900/30 rounded-lg p-4 border border-pink-500/20">
                  ...
                  <p className="text-[15px] mb-2">
                    旦角台步技巧丰富多姿，手势以
                    <span className="text-[#e3d7b1] font-semibold">耍花巾为最独特</span>，
                    表演细腻，生活气息浓郁。
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-[14px]">
                    <div>
                      <span className="text-[#e3d7b1] font-semibold">台步：</span>
                      一字步、十字步、交叉步、蹀步、云步、碎步等
                    </div>
                    <div>
                      <span className="text-[#e3d7b1] font-semibold">技巧：</span>
                      摘茶、采桑、纳鞋、撑船、推磨、绣花、耍伞等
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 rounded-lg p-4 border border-yellow-500/20">
                <p className="text-[16px]">
                  ...
                  ， 具有较强的艺术表现力。唱词通俗，多用生动的民间语汇，
                  <span className="text-[#e3d7b1] font-semibold">乡土气息浓厚</span>。
        ...
        >
          ...
          <div className="text-secondary text-[17px] leading-[30px] space-y-4">
            <p>
              &emsp;&emsp;芗剧作为
              <span className="text-[#e3d7b1] font-semibold">全国唯一横跨海峡的剧种</span>
              ，承载着深厚的历史文化内涵，
            ...
            <p>
              ...
              并引进西洋管弦乐，使
              <span className="text-[#e3d7b1] font-semibold">芗剧音乐更加丰富多彩，更具表现力</span>
              。
            </p>
            <p>
